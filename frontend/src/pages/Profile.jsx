    ...
    <div style={containerStyle}>
      ...
      >
        ...
        <button
          ...
          className="rounded-lg bg-red-500 px-5 py-2 font-semibold text-white transition hover:bg-red-600 hover:shadow-lg hover:shadow-red-500/20 hover:cursor-pointer"
        >
          Logout
        </button>
      </div>
